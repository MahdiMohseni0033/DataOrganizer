...
def create_parser():
    ...
    parser.add_argument('--csv_file_name', default='/media/mmohseni/ubuntu/storage/Houzz_dataset/exterior.csv', help='Path to the CSV file')
    parser.add_argument('--json_file_name', default='/media/mmohseni/ubuntu/projects/DataOrgnizer/crowler/exterior/exterior.json', help='Path to the JSON file')
    parser.add_argument('--save_directory', default='/media/mmohseni/ubuntu/storage/Houzz_dataset/exterior', help='Directory to save the images')
    return parser
